...
export default function Home() {
  ...
  const teamsInfo = [
    ...
    },
    {
      ...
      drivers: ["/drivers/max_verstappen.avif", "/drivers/hadjar.avif"],
      details: {
    ...
    },
    {
      ...
      drivers: ["/drivers/lawson.avif", "/drivers/lindblad.avif"],
      details: {
  ...
  useEffect(() => {
    const fetchCarImages = async () => {
      const currentSeason = "2026"; // You might want to make this dynamic
